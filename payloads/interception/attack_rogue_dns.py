...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "Rogue DNS Attack", font=FONT_TITLE, fill="#00FF00")
    ...
    if message_lines:
        ...
        d.text((5, 50), f"Malicious IP: {MALICIOUS_IP}", font=FONT, fill="white")
        d.text((5, 100), "OK=Start", font=FONT, fill="cyan")
        d.text((5, 110), "KEY1=Iface | KEY2=IP", font=FONT, fill="cyan")
    elif screen_state == "attacking":
        d.text((5, 50), "Running attack...", font=FONT_TITLE, fill="yellow")
        d.text((5, 70), f"Interface: {INTERFACE}", font=FONT, fill="white")
        d.text((5, 85), f"Malicious IP: {MALICIOUS_IP}", font=FONT, fill="white")
