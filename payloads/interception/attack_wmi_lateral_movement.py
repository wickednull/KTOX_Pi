#!/usr/bin/env python3
"""
KTOx *payload* – **WMI-Based Lateral Movement**
====================================================
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "WMI Lateral Movement", font=FONT_TITLE, fill=(30, 132, 73))
    ...
    if message_lines:
        ...
        d.text((5, 110), "KEY1=Target | KEY2=User/Pass", font=FONT, fill=(171, 178, 185))
...
def run_attack():
    ...
    # Path to wmiexec.py
    wmiexec_path = os.path.join(KTOX_ROOT, "impacket-examples", "wmiexec.py")
