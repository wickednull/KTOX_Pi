...
#!/usr/bin/env python3
"""
KTOx *payload* – **FTP Brute-Force Attack**
==============================================
...
# Paths prefer /root/KTOx
USER_LIST = os.path.join(KTOX_ROOT, "wordlists", "ftp_users.txt")
PASS_LIST = os.path.join(KTOX_ROOT, "wordlists", "ftp_pass.txt")
