...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "Firmware Downgrade", font=FONT_TITLE, fill="#00FF00")
    ...
    if message_lines:
        ...
        d.text((5, 50), f"Firmware: {os.path.basename(FIRMWARE_IMAGE)}", font=FONT, fill="white")
        d.text((5, 100), "OK=Start", font=FONT, fill="cyan")
        d.text((5, 110), "KEY1=Iface | KEY2=Firmware", font=FONT, fill="cyan")
    elif screen_state == "attacking":
        d.text((5, 50), "Running attack...", font=FONT_TITLE, fill="yellow")
        d.text((5, 70), f"Interface: {INTERFACE}", font=FONT, fill="white")
        d.text((5, 85), f"Firmware: {os.path.basename(FIRMWARE_IMAGE)}", font=FONT, fill="white")
