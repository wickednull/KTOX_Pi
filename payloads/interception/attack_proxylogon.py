#!/usr/bin/env python3
"""
KTOx *payload* – **ProxyLogon Attack**
===========================================
This payload performs a ProxyLogon attack (CVE-2021-26855) against a
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "ProxyLogon Attack", font=FONT_TITLE, fill=(30, 132, 73))
...
def run_attack():
    ...
    # Path to ProxyLogon exploit
    proxylogon_path = os.path.join(KTOX_ROOT, "proxylogon-exploit", "proxylogon.py")
...
if __name__ == "__main__":
    try:
        ...
        LCD.LCD_Clear()
        GPIO.cleanup()
        print("ProxyLogon Attack payload finished.")
