#!/usr/bin/env python3
"""
KTOx *payload* – **Telnet Brute-Force Attack**
=================================================
...
USER_LIST = os.path.join(KTOX_ROOT, "wordlists", "telnet_users.txt")
PASS_LIST = os.path.join(KTOX_ROOT, "wordlists", "telnet_pass.txt")
LOOT_DIR = os.path.join(KTOX_ROOT, "loot", "attack_telnet_bruteforce")
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    # Header
    d.text((5, 5), "Telnet Brute-Force", font=FONT_TITLE, fill=(231, 76, 60))
