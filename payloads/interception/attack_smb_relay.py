...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "SMB Relay Attack", font=FONT_TITLE, fill=(30, 132, 73))
...
def run_attack():
    ...
    ntlmrelayx_path = os.path.join(KTOX_ROOT, "impacket-examples", "ntlmrelayx.py")
