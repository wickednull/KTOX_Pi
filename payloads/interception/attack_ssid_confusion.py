#!/usr/bin/env python3
"""
KTOx *payload* – **SSID Confusion Attack (CVE-2023-52424)**
================================================================
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "SSID Confusion Attack", font=FONT_TITLE, fill=(30, 132, 73))
    ...
    if message_lines:
        ...
        d.text((5, 50), f"Spoofed SSID: {SPOOFED_SSID}", font=FONT, fill=(242, 243, 244))
        d.text((5, 100), "OK=Start", font=FONT, fill=(171, 178, 185))
        d.text((5, 110), "KEY1=Iface | KEY2=SSID", font=FONT, fill=(171, 178, 185))
        ...
        d.text((5, 85), f"Spoofed SSID: {SPOOFED_SSID}", font=FONT, fill=(242, 243, 244))
