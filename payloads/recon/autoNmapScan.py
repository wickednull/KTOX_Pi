#!/usr/bin/env python3
"""
KTOx *payload* – **Periodic Nmap Scan**
==========================================
This standalone script resides in the ``payloads/`` folder of your KTOx
...
# ----------------------------- Third-party libs ---------------------------
# These come pre-installed with KTOx.
...
def nmap_scan() -> None:
    ...
    try:
        ...
        # Clean output like KTOx main script
...
signal.signal(signal.SIGTERM, cleanup)    # KTOx UI stop
