#!/usr/bin/env python3
"""
KTOx Payload – Spam-Jam BLE/Bluetooth Attack Toolkit (Interactive)
==================================================================
Full interactive BLE/Bluetooth attack suite with on-screen keyboard.

Features:
  - BLE device scanning
  - BLE spamming & jamming
  - L2Ping attacks
  - RFCOMM floods
  - BLE Mesh botnet
...
def _display_output(lines):
    ...
    draw.text((4, 1), "SPAM JAM", font=ImageFont.load_default(), fill=(192, 57, 43))
...
def main():
    ...
    try:
        proc = subprocess.Popen(
            ["sudo", "python3", f"{SPAM_JAM_PATH}/spam_jam.py"],
