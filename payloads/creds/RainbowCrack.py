...
def draw_ui():
    ...
    draw.text((4,3), "RAINBOW CRACKER", font=font_sm, fill=(231, 76, 60))
    ...
    draw.text((4,56), f"Table: {os.path.basename(RAINBOW_TABLE_DIR)}", font=font_sm, fill=(171, 178, 185))
    draw.text((4,68), f"Progress: {progress[:16]}", font=font_sm, fill=(171, 178, 185))
