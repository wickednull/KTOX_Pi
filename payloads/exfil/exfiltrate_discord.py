#!/usr/bin/env python3
"""
KTOx *payload* – **Upload Loot to Discord**
================================================
This script gathers:
...
1.  Put this file in KTOx’s *payloads/* directory.
2.  Edit the ``WEBHOOK_URL`` constant below so it contains **your own** Discord webhook URL.
3.  Run it manually **or** add it to KTOx’s menu just like the other payloads.
...
signal.signal(signal.SIGTERM, cleanup)   # kill or KTOx quit
