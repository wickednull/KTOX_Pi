...
def draw_main():
    ...
    d.text((2, 15), f"T:{dst[:15]} [{enc_str}]", font=font, fill=(113, 125, 126))
    ...
    if active:
        ...
        d.text((2, 54), f"{bs}B sent", font=font, fill=(242, 243, 244))
        d.text((2, 66), f"Pkt {cs}/{tc}", font=font, fill=(242, 243, 244))
    elif not file_list:
...
def main():
    ...
    img = Image.new("RGB", (WIDTH, HEIGHT), (10, 0, 0))
    d = ScaledDraw(img)
    d.text((4, 20), "ICMP TUNNEL", font=font, fill=(171, 178, 185))
    d.text((4, 40), "Covert channel via", font=font, fill=(113, 125, 126))
    d.text((4, 52), "ICMP echo payloads", font=font, fill=(113, 125, 126))
    d.text((4, 72), "OK=Send  K1=Encrypt", font=font, fill=(86, 101, 115))
    d.text((4, 84), "K2=Target  K3=Exit", font=font, fill=(86, 101, 115))
    LCD.LCD_ShowImage(img, 0, 0)
    time.sleep(0.3)
