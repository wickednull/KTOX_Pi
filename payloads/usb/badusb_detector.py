...
def draw_alert(lcd, reason):
    ...
    d = ScaledDraw(img)
    font = scaled_font()
    d.rectangle((4, 4, 123, 123), outline=(242, 243, 244))
    d.text((10, 12), "!!! ALERT !!!", font=font, fill=(242, 243, 244))
    d.text((10, 34), "BadUSB DETECT", font=font, fill=(242, 243, 244))
    d.rectangle((10, 56, 118, 98), fill=(10, 0, 0))
    d.text((14, 62), reason[:16], font=font, fill=(242, 243, 244))
    d.text((10, 104), "KEY3 = Exit", font=font, fill=(242, 243, 244))
    lcd.LCD_ShowImage(img, 0, 0)
...
def draw_status(lcd):
    ...
    d = ScaledDraw(img)
    font = scaled_font()
    d.rectangle((0, 0, 127, 16), fill=(10, 0, 0))
    d.text((4, 2), "BadUSB Monitor", font=font, fill=(242, 243, 244))
    # Simple USB/Keyboard icons
    # USB icon (left)
    d.line((90, 4, 90, 12), fill=(242, 243, 244))
    d.line((90, 4, 96, 4), fill=(242, 243, 244))
    d.line((96, 4, 96, 6), fill=(242, 243, 244))
    d.line((90, 12, 94, 12), fill=(242, 243, 244))
    d.line((94, 12, 94, 10), fill=(242, 243, 244))
    # Keyboard icon (right)
    d.rectangle((104, 3, 122, 13), outline=(242, 243, 244), fill=None)
    d.rectangle((106, 6, 120, 10), outline=None, fill=(242, 243, 244))
    d.text((4, 22), "Status: READY", font=font, fill=(30, 132, 73))
    d.text((4, 40), "USB: watching", font=font, fill=(242, 243, 244))
    d.text((4, 58), "Keys: any", font=font, fill=(242, 243, 244))
    d.text((4, 76), "KEY3 to exit", font=font, fill=(242, 243, 244))

    if time.time() < status_until and status_message:
        d.rectangle((6, 92, 121, 120), fill=(10, 0, 0), outline=(242, 243, 244))
        d.text((10, 98), status_message[:16], font=font, fill=(242, 243, 244))
    lcd.LCD_ShowImage(img, 0, 0)
