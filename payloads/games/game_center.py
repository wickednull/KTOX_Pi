...
EMULATORS = {
    ...
    "psx": {"name": "PlayStation 1", "engine": "PCSX-ReARMed (RetroArch)", "apt": ["retroarch", "libretro-pcsx-rearmed"], "ext": [".cue", ".bin", ".chd", ".pbp"], "notes": "Playable with light settings and frameskip."},
