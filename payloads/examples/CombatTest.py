...
# ----------------------------------------------------------------------
# Game Engine (original, plus extended story methods)
# ----------------------------------------------------------------------
class Game:
    def __init__(self):
        self.inventory = []
...
# =============================================================================
# SCENE DEFINITIONS (all original scenes – unchanged, except hub now has Story Missions)
# =============================================================================
...
# --------------------- CENTRAL HUB: AFTERLIFE (modified to include Story Missions) ---------------------
def scene_afterlife_hub(g):
    ...
    choices = ["Story Missions", "Talk to Fixer (gigs)", "Talk to Bartender (food/rumors)", "Visit Shop", "Talk to your crew", "Save Game", "Leave"]
    idx = g.choose(choices)
    if idx == 0:
        g.mission_select()
...
# --------------------- REST OF ORIGINAL SCENES (all preserved) ---------------------
...
# --------------------- ENDINGS (removed Jin romance ending) ---------------------
def ending_legend(g):
    g.show_text([
