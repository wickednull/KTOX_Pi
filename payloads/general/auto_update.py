...
# LCD, fonts — initialised inside main() so exec_payload() import is clean
...
try:
    ...
    # Ensure rj_input.py exists as an alias for ktox_input.py
    rj = dst / "rj_input.py"
    ki = dst / "ktox_input.py"
    if ki.exists():
        try:
