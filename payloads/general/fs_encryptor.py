#!/usr/bin/env python3
"""
KTOx *payload* – **Filesystem Encryptor**
============================================
...
SANDBOX_DIR = os.path.join(KTOX_ROOT, "Desktop", "RANSOMWARE_TEST_FILES")
XOR_KEY = 0xDE
LOOT_DIR = os.path.join(KTOX_ROOT, 'loot', 'fs_encryptor')
...
if __name__ == '__main__':
    ...
    try:
        ...
        LCD.LCD_Clear()
        GPIO.cleanup()
        print("Encryptor payload finished.")