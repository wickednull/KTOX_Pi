#!/usr/bin/env python3
"""
KTOx *payload* – **MAC Spoof (wlan0)**
========================================
This payload changes the MAC address of the `wlan0` wireless network interface
to a randomly generated one. MAC address spoofing can be used for privacy,
bypassing MAC-based filtering, or impersonating other devices on a network.

Features:
- Changes the MAC address of `wlan0` to a random MAC.
