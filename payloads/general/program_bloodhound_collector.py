#!/usr/bin/env python3
"""
KTOx *payload* – **BloodHound Data Collection**
====================================================
...
def draw_ui(screen_state="main", message_lines=None):
    ...
    d.text((5, 5), "BloodHound Collector", font=FONT_TITLE, fill=(30, 132, 73))
    ...
    if message_lines:
        ...
        d.text((5, 100), "OK=Collect", font=FONT, fill=(171, 178, 185))
        d.text((5, 110), "KEY1=Domain | KEY2=User/Pass", font=FONT, fill=(171, 178, 185))
    elif screen_state == "collecting":
        d.text((5, 50), "Collecting data...", font=FONT_TITLE, fill=(212, 172, 13))
...
def run_collection():
    ...
    bloodhound_path = os.path.join(KTOX_ROOT, "BloodHound.py", "bloodhound.py")
    ...
    try:
        ...
        if process.returncode == 0:
            ...
            loot_dir = os.path.join(KTOX_ROOT, "loot", "bloodhound")
