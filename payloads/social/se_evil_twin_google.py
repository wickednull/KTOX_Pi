#!/usr/bin/env python3
"""
KTOx *payload* – **Evil Twin (Google Phishing)**
===================================================
...
- MAIN SCREEN:
    ...
    - KEY1: Edit Fake AP SSID. (Modified from original functionality)
    - KEY2: Edit Fake AP Channel. (Modified from original functionality)
...
TEMP_CONF_DIR = "/tmp/ktox_eviltwin_google/"
...
if __name__ == '__main__':
    ...
    try:
        ...
        LCD.LCD_Clear()
        GPIO.cleanup()
        print("SE Evil Twin (Google) payload finished.")
