...
def validate_integration() -> None:
    ...
    require("sdrServiceToggle" in web_html and "sdrServiceStop" in web_html and "sdrServiceStatus" in web_html, "main WebUI must expose SDR service memory-saving controls")
