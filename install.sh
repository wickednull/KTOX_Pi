...
# rj_input.py alias — ktox_device.py imports rj_input; ktox_input.py is the real file

# Create a symlink so both import names resolve correctly

ln -sf “$KTOX_DIR/ktox_input.py” “$KTOX_DIR/rj_input.py”

# Legacy: if rj_input.py existed in ktox_pi/, copy it as ktox_input.py
...
try:    **import**(mod.split(’.’)[0]); print(f”  ok  {mod}”)
