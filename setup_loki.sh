...
echo "  python3 $KTOX_DIR/payloads/servers/loki_manager.py start"
echo "  python3 $KTOX_DIR/payloads/servers/loki_manager.py status"
echo "  python3 $KTOX_DIR/payloads/servers/loki_manager.py stop"
echo ""
