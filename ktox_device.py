    ...
    while True:
        with draw_lock:
            ...
            if icon and _ui_ux.get("show_icons", True):
                ...
                display_txt = _truncate(txt.strip().lstrip("✔*+-•> "), 96, font=text_font)
                draw.text((64, 101), display_txt, font=text_font, fill=color.text, anchor="mm")
            else:
    ...
    while True:
        with draw_lock:
            ...
            for i in range(SIDEBAR_ITEMS):
                ...
                if icon and _ui_ux.get("show_icons", True):
                    draw.text((18, y + 9), icon, font=icon_font or small_font, fill=fill, anchor="mm")
                else:
                    draw.text((18, y + 9), (label.strip()[:1] or "•"), font=small_font, fill=fill, anchor="mm")
